...
def sync() -> int:
    ...
    print(f"[sync_prticket] sedes_sin_localidad_generica: {sedes_sin_localidad_generica}")
    print(f"[sync_prticket] sedes_sin_localidad_no_pr: {sedes_sin_localidad_non_pr}")
    print(f"[sync_prticket] sedes_localidad_con_coords: {sedes_localidad_con_coords}")
